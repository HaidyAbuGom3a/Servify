...
import org.haidy.servify.presentation.screens.verified.navigateToVerified
...
fun VerifyEmailScreen(viewModel: VerifyEmailViewModel = hiltViewModel()) {
    ...
    EffectHandler(effects = viewModel.effect) { effect, navController ->
        when (effect) {
            VerifyEmailUiEffect.NavigateUp -> navController.popBackStack()
            VerifyEmailUiEffect.NavigateToVerified -> navController.navigateToVerified(true)
        }
    }
    VerifyEmailContent(state, viewModel)
}

@Composable
fun VerifyEmailContent(state: VerifyEmailUiState, listener: VerifyEmailInteractionListener) {
    Scaffold(
        topBar = {
            ServifyAppBar(
        ...
        Column(
            ...
            Text(
                text = Resources.strings.enterTheVerifyCode,
            ...
            Text(
                modifier = Modifier
                    ...
                    .fillMaxWidth(),
                text = Resources.strings.weSentVerificationCodeTo,
            ...
            Row(
                ...
                Text(
                    modifier = Modifier
                        .padding(start = 4.dp)
                        .noRippleEffect { listener.onClickResendCode() },
